...
b_2 = Button(frame_quadros, text="%", width=6, height=1, bg=co10, fg=fundo, font=('Ivy 10 bold'), relief=RAISED, overrelief=RIDGE, command=lambda:entering_values('%'))
b_2.place(x=118, y=0)

b_3 = Button(frame_quadros, text="/", width=6, height=1, bg=co10, fg=fundo, font=('Ivy 10 bold'), relief=RAISED, overrelief=RIDGE, command=lambda:entering_values('/'))
b_3.place(x=177, y=0)
...
b_7 = Button(frame_quadros, text="*", width=6, height=1, bg=co10, fg=fundo, font=('Ivy 10 bold'), relief=RAISED, overrelief=RIDGE, command=lambda:entering_values('*'))
...
b_11 = Button(frame_quadros, text="-", width=6, height=1, bg=co10, fg=fundo, font=('Ivy 10 bold'), relief=RAISED, overrelief=RIDGE, command=lambda:entering_values('-'))
...
b_15 = Button(frame_quadros, text="+", width=6, height=1, bg=co10, fg=fundo, font=('Ivy 10 bold'), relief=RAISED, overrelief=RIDGE, command=lambda:entering_values('+'))
...
b_18 = Button(frame_quadros, text="=", width=6, height=1, bg=co10, fg=fundo, font=('Ivy 10 bold'), relief=RAISED, overrelief=RIDGE, command=lambda:calculate())
